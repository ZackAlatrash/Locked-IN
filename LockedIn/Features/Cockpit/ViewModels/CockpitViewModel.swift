...
final class CockpitViewModel: ObservableObject {
    ...
    func complete(protocolModel: NonNegotiable) throws -> CockpitCompletionExecutionResult {
        ...
        let outcome = try commitmentService.recordCompletionDetailed(for: protocolModel.id, at: completionDate)
        ...
        commitmentService.runDailyIntegrityTick(referenceDate: nowProvider())
